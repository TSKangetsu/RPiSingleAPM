...
This project differs from Baseflight and inav in that it focuses on running controller in ARM-Linux, and suit for indoor navigation.
This project use some parts of Cleanfilght and inav , but it's not a fork.
